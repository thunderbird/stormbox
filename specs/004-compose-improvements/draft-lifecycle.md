...
| CD-1.7 🟩 Done | Close and discard shall be unavailable while the session is sending, from the dock as well as from the expanded composer. A sending session docks at activation and may be restored and minimized freely, but its content and send controls stay inert until the send settles (CS-1.15, CS-1.16). The docked bar shall show the send state — “Sending…”, “Scheduling…”, or “Send failed” with a marker — alongside the CD-1.6 label. |
